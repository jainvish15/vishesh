...
public class MainActivity extends Activity implements Ari.StartCallback,
                                                      ...
                                                      UpSwipeEvent.Listener,
                                                      DownSwipeEvent.Listener {
         private ActiveAri mAri;
         private WebView mWebview; // Should be Private
         private EditText urlEditText; // Should be Private
        ...
        protected void onCreate(Bundle savedInstanceState) {  // focus on spacing on every functionality 
                ...
                try    {
                                mAri = ActiveAri.getInstance(getString(R.string.ari_api_key), getApplicationContext()).addErrorCallback(this).addListeners(this);
